  ...
  return {
    ...
    execute: function () {
      ...
      _export("default", UIButton = (_dec = menu('core/UIButton'), _dec2 = property({
        ...
        set grayScale(value) {
          var iconSpr = this.node.getComponent(Sprite) || this.node.getComponentInChildren(Sprite);
        ...
        set interactable(value) {
          var iconSpr = this.node.getComponentInChildren(Sprite);
...
//# sourceMappingURL=7789320ad1a50d248b6d622ea652677a1b474e0b.js.map